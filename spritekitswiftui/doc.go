// Package spritekitswiftui provides Go bindings for Apple's SpriteKit
// SwiftUI cross-import overlay (_SpriteKit_SwiftUI).
//
// This overlay provides SwiftUI views and modifiers that integrate
// SpriteKit with SwiftUI. All view constructors return uintptr values
...
//	import "github.com/tmc/appledocs/swift-bridge/spritekitswiftui"
//
//	ptr := spritekitswiftui.NewSpriteView(...)
