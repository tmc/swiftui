// Package localauthswiftui provides Go bindings for Apple's LocalAuthentication
...
//	import "github.com/tmc/appledocs/swift-bridge/localauthswiftui"
//
//	ptr := localauthswiftui.NewLocalAuthView(...)
